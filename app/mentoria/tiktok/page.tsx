      ...
      <section className="relative z-10 px-4 pt-1 pb-6">
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            >
              Tráfego Direto & TikTok Ads do jeito certo.
            </h1>
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "1rem", lineHeight: "1.6" }}>
              Oferta, criativo, validação e escala usando Facebook Ads e TikTok Ads rodando tráfego direto.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            ...
            <p className="leading-relaxed text-lg" style={{ color: "#F4F4F5" }}>
              Dominar as estruturas de tráfego direto no TikTok Ads e Facebook Ads — criar criativos que convertem, validar ofertas com investimento mínimo e escalar de forma previsível.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative z-10 py-6">
        <div className="max-w-2xl mx-auto px-4 flex flex-col gap-4">
              ...
              {testimonialImages.map((src, i) => (
                ...
                >
                  <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(168,85,247,0.15)" }}>
                    <img src={src} alt={`Depoimento ${i + 1}`} className="w-full h-auto object-cover" loading="lazy" />
                  </div>
                </div>
              ))}
            </div>
          ...
          >
            ...
            , o critério que uso para decidir se uma oferta tem potencial: criativo validado + checkout otimizado + margem para escala. Sem os três, não subo o budget.
          </motion.div>
